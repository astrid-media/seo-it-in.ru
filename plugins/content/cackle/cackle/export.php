...
function cackle_export_wxr_cdata($string) {
    ...
    if ($encoding == "Windows-1251"){
        $cackle_api->cackle_set_param("cackle_encoding","cp1251");
...
function cackle_export_wp($post, $url) {
    $comments_query = "SELECT * FROM ".PREFIX."_comments WHERE post_id = $post AND user_agent NOT LIKE 'Cackle:%%' order by date asc";
    global $cackle_api;
