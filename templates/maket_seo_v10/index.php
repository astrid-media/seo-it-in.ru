...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $templateUrl; ?>/css/template.css?v=1.0.2" media="screen" type="text/css" />
...
<amp-auto-ads type="adsense"
              data-ad-client="ca-pub-2504898557873632">
</amp-auto-ads>
...
<?php else: ?>
        <p>Хочешь поделиться полезной статьей? Мы принимаем <a href="/gostevoj-post">гостевые посты</a></p>
        <p>Сотрудничество: <a href="mailto:info@astrid-media.ru">info@astrid-media.ru</a></p>
        <p>© 2013-2023 || Блог Игоря Волкова «SEO в интернет-маркетинге»</p>
    <?php endif; ?>
